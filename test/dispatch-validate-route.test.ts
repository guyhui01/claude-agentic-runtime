...
const FAKE_SIDECAR: Sidecar = {
  ...
  assets: [
    { id: "AGENT-BUSINESS-ANALYST", type: "agent", path: "agents/ba.md", title: "BA", description: "d", catalogVersion: "v4.4.0", source: { file: "agents/ba.md", catalogTag: "v4.4.0" } },
    { id: "AGENT-PO-SCRUM", type: "agent", path: "agents/po.md", title: "PO", description: "d", catalogVersion: "v4.4.0", source: { file: "agents/po.md", catalogTag: "v4.4.0" } },
    {
      id: "WF-001",
      type: "workflow",
      ...
      source: { file: "workflows/WF-001.md", catalogTag: "v4.4.0" },
    ...
    },
    {
      ...
      catalogVersion: "v4.4.0",
      source: { file: "workflows/WF-002.md", catalogTag: "v4.4.0" },
    ...
    },
    {
      ...
      catalogVersion: "v4.4.0",
      source: { file: "workflows/WF-003.md", catalogTag: "v4.4.0" },
      dependsOn: ["AGENT-BUSINESS-ANALYST"],
    },
    {
      id: "WF-004",
      ...
      catalogVersion: "v4.4.0",
      source: { file: "workflows/WF-004.md", catalogTag: "v4.4.0" },
      dependsOn: ["AGENT-BUSINESS-ANALYST"],
    },
    {
      id: "WF-005",
      ...
      catalogVersion: "v4.4.0",
      source: { file: "workflows/WF-005.md", catalogTag: "v4.4.0" },
      dependsOn: ["AGENT-BUSINESS-ANALYST"],
    },
    {
      id: "WF-006",
      ...
      catalogVersion: "v4.4.0",
      source: { file: "workflows/WF-006.md", catalogTag: "v4.4.0" },
      dependsOn: ["AGENT-BUSINESS-ANALYST"],
    },
    {
      id: "WF-007",
      ...
      catalogVersion: "v4.4.0",
      source: { file: "workflows/WF-007.md", catalogTag: "v4.4.0" },
      dependsOn: ["AGENT-BUSINESS-ANALYST"],
    },
    {
      id: "WF-008",
      ...
      catalogVersion: "v4.4.0",
      source: { file: "workflows/WF-008.md", catalogTag: "v4.4.0" },
      dependsOn: ["AGENT-BUSINESS-ANALYST"],
    },
    {
      id: "WF-009",
      ...
      catalogVersion: "v4.4.0",
      source: { file: "workflows/WF-009.md", catalogTag: "v4.4.0" },
      dependsOn: ["AGENT-BUSINESS-ANALYST"],
    },
    {
      id: "WF-010",
      ...
      catalogVersion: "v4.4.0",
      source: { file: "workflows/WF-010.md", catalogTag: "v4.4.0" },
      dependsOn: ["AGENT-BUSINESS-ANALYST"],
    },
    {
      ...
      catalogVersion: "v4.4.0",
      source: { file: "workflows/WF-UNMANIFESTED.md", catalogTag: "v4.4.0" },
      dependsOn: ["AGENT-BUSINESS-ANALYST"],
    },
    {
      id: "WF-BROKEN",
      ...
      description: "d",
      catalogVersion: "v4.4.0",
      source: { file: "workflows/WF-BROKEN.md", catalogTag: "v4.4.0" },
